...
public class KamisActivity extends AppCompatActivity {
    ...
    private void JadwalKamis() {
        SQLiteDatabase db = dbcenter.getReadableDatabase();
        Cursor cursor = db.rawQuery("SELECT * FROM jadwal where hari = 'Kamis'", null);
        ...
        ListView01.setOnItemClickListener((new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(KamisActivity.this);
