...
public class SelasaActivity extends AppCompatActivity {
    String[] daftar;
    ListView ListView01;
    Menu menu;
    DataHelper dbcenter;
    ...
    private void JadwalSelasa() {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM jadwal where hari = 'Selasa'", null);
        ...
        ListView01.setOnItemClickListener((new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(SelasaActivity.this);
